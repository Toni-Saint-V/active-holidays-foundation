...
- Load references only when needed:
  - `_internal/bank-grade-review-references/review-rubric.md` for lens selection and artifact-specific checklists
  - `_internal/bank-grade-review-references/severity-model.md` for prioritization and finding quality
  - `_internal/bank-grade-review-references/forward-risk-checklist.md` for maintainability and extensibility stress tests
...
- That handoff block must include:
  ...
  - a direct instruction to run post-task review through `ah-review-release` and this internal bank-grade reference when needed

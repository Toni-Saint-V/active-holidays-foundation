...
export function ResultPageClient() {
  ...
  return (
    <main className="mx-auto w-full max-w-6xl px-5 pb-32 pt-6 md:px-10">
      <article
        data-engine-class={ENGINE_CLASS}
        className="relative overflow-hidden rounded-4xl border border-white/10 bg-black/20 p-5 md:p-8"
      >
        {!heroImageBroken && (
          <Image
            ...
            className="pointer-events-none absolute inset-0 -z-10 object-cover opacity-15 blur-sm"
          />
        )}
